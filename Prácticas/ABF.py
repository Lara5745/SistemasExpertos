...
# Este programa ilustra un ejemplo de árbol de búsqueda binaria usando Python
# Árbol de búsqueda binaria, es una estructura de datos de árbol binario basada en nodos que tiene las siguientes propiedades:
#
